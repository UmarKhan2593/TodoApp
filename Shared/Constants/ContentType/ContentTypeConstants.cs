...
namespace TaskManager.Infrastructure.Shared.Constants.ContentType
{
    /// <summary>
    /// ContentTypes Common mime types. 
    /// </summary>
    public static class ContentTypeConstants
    {
        ...
        [Obsolete(message: "No longer in required in latest browsers.")]
